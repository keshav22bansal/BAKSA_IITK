...
experiment_details = 'gru128_subword'
filename = 'match.txt'
batch_size = 128
numclasses = 3
...
print(y_test.shape)
f = open(Masterdir+Modeldir+'GRU_'+experiment_details+'_architecture.json','r+')
json_string = f.read()
f.close()
model = model_from_json(json_string)

model.load_weights(Masterdir+Modeldir+'GRU_'+experiment_details+'_weights.h5')
