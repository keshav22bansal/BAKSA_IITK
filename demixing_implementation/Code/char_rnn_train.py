...
Modeldir = 'Models/'
Featuredir = 'Features/'
inputdatasetfilename = "train_new_demojise.txt"
testdatasetfilename = "validation_new_demojise.txt"
...
if __name__ == '__main__':
	...
	out = parse(Masterdir,testdatasetfilename,SEPERATOR,DATA_COLUMN,LABEL_COLUMN,LABELS)
	X_test = out[0]
	y_test = out[1]
	...
	out = convert_char2num(mapping_num2char,mapping_char2num,X_total,MAXLEN)
	mapping_num2char = out[1]
	mapping_char2num = out[2]
	MAX_FEATURES = out[3]
	X_total = out[0]
	X_train = X_total[:len_xtrain]
	X_test = X_total[len_xtrain:]
