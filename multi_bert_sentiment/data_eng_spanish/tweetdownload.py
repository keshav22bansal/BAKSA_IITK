...
parser.add_argument('--consumerkey', required=False, help='Consumer key.')
parser.add_argument('--consumersecret', required=False, help='Consumer secret.')
parser.add_argument('--accesstoken', required=False, help='Access token.')
parser.add_argument('--accesssecret', required=False, help='Access token secret.')
...
CONSUMER_KEY = 'H1E1CuLWqD44y4CFMi20WWQ3G'
CONSUMER_SECRET = '6YABjVxGj96BkXpZ9DXe9d2Y3vKniREunCmxT7zyBvwU6R8R6Z'
ACCESS_TOKEN = '1215970284781522945-DcPyRdNnGSPjtQN7c7OYsSJrx3olvp'
ACCESS_SECRET = 'AwsjPnOEQOQY6LRFW1EgOFvbDA6hRrDns2TVA1cnpiIs6'
